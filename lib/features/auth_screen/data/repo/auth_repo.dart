...
abstract class AuthRepo{
  Future<Either<AuthModel,AppException>> login(String username,String password);
}
class AuthRepoImpl implements AuthRepo{
    ...
    @override
    Future<Either<AuthModel, AppException>> login(String username, String password) async {
      try {
